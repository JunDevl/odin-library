...
function insertToLibrary(...books) {
  ...
  const generateBookElement = (book) => {
    ...
    container.setAttribute("uuid", book.uuid);
    ...
    bin.innerHTML = `
    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 72 72" class="trash" uuid="${book.uuid}">
      <path 
